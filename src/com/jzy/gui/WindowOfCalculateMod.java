 ...
 *
 * @Title: WindowOfCalculateMod.java
 * @Package com.jzy.gui
...
/**
 * @ClassName: WindowOfCalculateMod
 * @Description: 最小非负余数和绝对值最小余数计算图形类
 * @author: JinZhiyun
 * @date: 2019年3月16日 下午12:19:01
 *
...
public class WindowOfCalculateMod {
    ...
    public static void GUICalculateModHidden(JFrame frm) {
        ...
        btn.addActionListener(new ActionListener() { // 按钮响应事件
            @Override
            public void actionPerformed(ActionEvent e) {
                if (StringTest.isInteger(jtf1.getText()) && StringTest.isLegalNonNegativeInteger(jtf2.getText())
