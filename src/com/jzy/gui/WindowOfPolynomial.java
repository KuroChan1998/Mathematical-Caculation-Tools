...
public class WindowOfPolynomial {
     ...
     */
    private static Polynomial p1 = Method1.POLY_0;
    private static Polynomial p2 = Method1.POLY_0;
    ...
    public static void GUIPolynomialHidden(JFrame frm) {
        ...
        btnp3.addActionListener(new ActionListener() { // 按钮响应事件
            @Override
            public void actionPerformed(ActionEvent e) {
                if (StringTest.isLegalInteger(jtf4.getText())) {
                    if (!StringTest.isLegalIntegerBetweenMinAndMax(jtf4.getText(), BigInteger.valueOf(0), BigInteger.valueOf(Polynomial.MAX_DEG))) {
                        JOptionPane.showMessageDialog(null, "输入多项式的最高次数应该在" + 0 + "~" + Polynomial.MAX_DEG + "之间！");
                    } else {
        ...
        btnp8.addActionListener(new ActionListener() { // 按钮响应事件
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (PolynomialTest.ifEqualZero(p2)) {
        ...
        btnp10.addActionListener(new ActionListener() { // 按钮响应事件
            @Override
            public void actionPerformed(ActionEvent e) {
                if (StringTest.isLegalInteger(jtf90.getText())) {
                    if (!StringTest.isLegalIntegerBetweenMinAndMax(jtf90.getText(), BigInteger.valueOf(0), BigInteger.valueOf(Polynomial.MAX_DEG))) {
                        JOptionPane.showMessageDialog(null, "输入多项式的最高次数应该在" + 0 + "~" + Polynomial.MAX_DEG + "之间！");
                    } else {
                        int deg = Integer.parseInt(jtf90.getText());
                        if (deg * p1.effectiveMaxDeg > Polynomial.MAX_DEG) {
                            JOptionPane.showMessageDialog(null, "计算结果多项式最高次数超过了规定最大值" + Polynomial.MAX_DEG);
                        } else {
                            Polynomial polynomial = Polynomial.pow(p1, deg);
        ...
        btnp11.addActionListener(new ActionListener() { // 按钮响应事件
            ...
            public void actionPerformed(ActionEvent e) {
                Polynomial polynomial;
                if (PolynomialTest.ifEqualZero(p1) || PolynomialTest.ifEqualZero(p1)) {
                    JOptionPane.showMessageDialog(null, "p1或p2不能为0");
                } else {
                    try {
                        polynomial = Method1.maxCommonFactor(p1, p2);
        ...
        btnp12.addActionListener(new ActionListener() { // 按钮响应事件
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (PolynomialTest.ifEqualZero(p1) || PolynomialTest.ifEqualZero(p1)) {
                    ...
                    try {
                        polynomial = Method1.minCommonMultiple(p1, p2);
        ...
        btnp13.addActionListener(new ActionListener() { // 按钮响应事件
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (PolynomialTest.ifEqualZero(p1)) {
                    ...
                    try {
                        r1 = Method1.ifPrimPolynomial(p1);
                        r2 = Method1.ifReduciblePolynomial(p1);
        ...
        btnp15.addActionListener(new ActionListener() { // 按钮响应事件
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (PolynomialTest.ifEqualZero(p1) || PolynomialTest.ifEqualZero(p1)) {
                    ...
                    try {
                        polynomial = Method1.polynomialBezoutSolveQrSt(p1, p2);
