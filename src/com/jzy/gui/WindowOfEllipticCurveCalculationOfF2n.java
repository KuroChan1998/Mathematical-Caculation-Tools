...
public class WindowOfEllipticCurveCalculationOfF2n {
     ...
     * @Fields p : 多项式p
     */
    private static Polynomial p = Method1.POLY_0;

    /**
     * @Fields a2 : 系数a2
     */
    private static Polynomial a2 = Method1.POLY_0;

    /**
     * @Fields a6 : 系数a6
     */
    private static Polynomial a6 = Method1.POLY_0;
     ...
     */
    private static Polynomial[] p1 = {Method1.POLY_0, Method1.POLY_0};
    private static Polynomial[] p2 = {Method1.POLY_0, Method1.POLY_0};
    ...
    /**
     * @Title: GUIEllipticCurveCalculationOfF2n
     * @Description: 设置F2n上的椭圆曲线y^2+xy=x^3+a2*x^2+a6的点的计算图形模块
     * @param: @param frm
     * @return: void
     * @throws
     */
    public static void GUIEllipticCurveCalculationOfF2n(JFrame frm) {
        ...
        btn.addActionListener(new ActionListener() { // 按钮响应事件
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                GUIEllipticCurveCalculationOfF2nHidden(frmHidden);
    ...
    /**
     * @Title: GUIEllipticCurveCalculationOfF2nHidden
     * @Description: 点击进入后的F2n上的椭圆曲线y^2+xy=x^3+a2*x^2+a6的点的计算图形模块
     * @param: @param frm
     * @return: void
     * @throws
     */
    public static void GUIEllipticCurveCalculationOfF2nHidden(JFrame frm) {
        ...
        btnp1.addActionListener(new ActionListener() { // 按钮响应事件
            @Override
            public void actionPerformed(ActionEvent e) {
                if (StringTest.isLegalInteger(jtf2.getText())) {
                    if (!StringTest.isLegalIntegerBetweenMinAndMax(jtf2.getText(), BigInteger.valueOf(0), BigInteger.valueOf(Polynomial.MAX_DEG))) {
                        JOptionPane.showMessageDialog(null, "输入多项式的最高次数应该在" + 0 + "~" + Polynomial.MAX_DEG + "之间！");
                    } else {
        ...
        btnpa2.addActionListener(new ActionListener() { // 按钮响应事件
            @Override
            public void actionPerformed(ActionEvent e) {
                if (StringTest.isLegalInteger(jtfa21.getText())) {
                    if (!StringTest.isLegalIntegerBetweenMinAndMax(jtfa21.getText(), BigInteger.valueOf(0), BigInteger.valueOf(Polynomial.MAX_DEG))) {
                        JOptionPane.showMessageDialog(null, "输入多项式的最高次数应该在" + 0 + "~" + Polynomial.MAX_DEG + "之间！");
                    } else {
        ...
        btnpa6.addActionListener(new ActionListener() { // 按钮响应事件
            @Override
            public void actionPerformed(ActionEvent e) {
                if (StringTest.isLegalInteger(jtfa61.getText())) {
                    if (!StringTest.isLegalIntegerBetweenMinAndMax(jtfa61.getText(), BigInteger.valueOf(0), BigInteger.valueOf(Polynomial.MAX_DEG))) {
                        JOptionPane.showMessageDialog(null, "输入多项式的最高次数应该在" + 0 + "~" + Polynomial.MAX_DEG + "之间！");
                    } else {
        ...
        btnp3.addActionListener(new ActionListener() { // 按钮响应事件
            @Override
            public void actionPerformed(ActionEvent e) {
                if (StringTest.isLegalInteger(jtf6.getText())) {
                    if (!StringTest.isLegalIntegerBetweenMinAndMax(jtf6.getText(), BigInteger.valueOf(0), BigInteger.valueOf(Polynomial.MAX_DEG))) {
                        JOptionPane.showMessageDialog(null, "输入多项式的最高次数应该在" + 0 + "~" + Polynomial.MAX_DEG + "之间！");
                    } else {
        ...
        btnp5.addActionListener(new ActionListener() { // 按钮响应事件
            @Override
            public void actionPerformed(ActionEvent e) {
                if (StringTest.isLegalInteger(jtf8.getText())) {
                    if (!StringTest.isLegalIntegerBetweenMinAndMax(jtf8.getText(), BigInteger.valueOf(0), BigInteger.valueOf(Polynomial.MAX_DEG))) {
                        JOptionPane.showMessageDialog(null, "输入多项式的最高次数应该在" + 0 + "~" + Polynomial.MAX_DEG + "之间！");
                    } else {
        ...
        btnp7.addActionListener(new ActionListener() { // 按钮响应事件
            @Override
            public void actionPerformed(ActionEvent e) {
                if (StringTest.isLegalInteger(jtf10.getText())) {
                    if (!StringTest.isLegalIntegerBetweenMinAndMax(jtf10.getText(), BigInteger.valueOf(0), BigInteger.valueOf(Polynomial.MAX_DEG))) {
                        JOptionPane.showMessageDialog(null, "输入多项式的最高次数应该在" + 0 + "~" + Polynomial.MAX_DEG + "之间！");
                    } else {
        ...
        btnp9.addActionListener(new ActionListener() { // 按钮响应事件
            @Override
            public void actionPerformed(ActionEvent e) {
                if (StringTest.isLegalInteger(jtf15.getText())) {
                    if (!StringTest.isLegalIntegerBetweenMinAndMax(jtf15.getText(), BigInteger.valueOf(0), BigInteger.valueOf(Polynomial.MAX_DEG))) {
                        JOptionPane.showMessageDialog(null, "输入多项式的最高次数应该在" + 0 + "~" + Polynomial.MAX_DEG + "之间！");
                    } else {
        ...
        btnp11.addActionListener(new ActionListener() { // 按钮响应事件
            @Override
            public void actionPerformed(ActionEvent e) {
                EllipticCurveCalculationOfF2n ellipticCurveCalculationOfF2N = new EllipticCurveCalculationOfF2n(p, a2, a6);
                try {
        ...
        btnp12.addActionListener(new ActionListener() { // 按钮响应事件
            ...
            public void actionPerformed(ActionEvent e) {
                EllipticCurveCalculationOfF2n ellipticCurveCalculationOfF2N = new EllipticCurveCalculationOfF2n(p, a2, a6);
                if (!StringTest.isLegalIntegerBetweenMinAndMax(jtf17.getText(), BigInteger.valueOf(0), BigInteger.valueOf(EllipticCurveCalculationOfF2n.MAX_K))) {
                    JOptionPane.showMessageDialog(null, "k应该在1~" + EllipticCurveCalculationOfF2n.MAX_K + "之间！");
                } else {
